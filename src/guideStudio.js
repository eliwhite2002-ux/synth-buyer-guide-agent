...
function renderStudioPage(layout, extractionResult = null) {
  return layout('Research Studio', `
    ...
    <section class="panel extractor-panel" id="extractor">
      ...
      <p class="muted">Deterministic fixtures: <code>mock://vendor-homepage</code>, <code>mock://product-model-one</code>, <code>mock://product-compact-tpe</code>, <code>mock://product-large-silicone</code>, <code>mock://product-incomplete</code>, <code>mock://category-silicone</code>, <code>mock://article-first-time-buyers</code>, <code>mock://blocked-access-wall</code>.</p>
